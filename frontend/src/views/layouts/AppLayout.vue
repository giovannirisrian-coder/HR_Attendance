    ...
    <aside class="sidebar" :class="{ collapsed: sidebarCollapsed }">
      ...
      <nav class="sidebar-nav">
        ...
        <template v-if="user?.role === 'vendor'">
          ...
          <router-link to="/vendor/config" class="nav-item" active-class="active">
            ...
            <span v-if="!sidebarCollapsed">Config</span>
          </router-link>
        </template>
        ...
        <template v-if="user?.role === 'ls_hr'">
          ...
          <router-link to="/ls-hr/employees" class="nav-item" active-class="active" title="Manage employee master data for vendors">
...
const pageTitle = computed(() => {
  ...
  if (path.includes('/vendor/config')) return 'Configuration';
