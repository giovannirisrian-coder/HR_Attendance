...
const routes = [
...

  {
    ...
    children: [
      ...
      { path: 'master-data/employee-groups', component: () => import('../views/ls-hr/EmployeeGroupList.vue') },
      { path: 'master-data/employee-groups/create', component: () => import('../views/ls-hr/EmployeeGroupCreate.vue') },
      { path: 'master-data/employee-groups/:id/edit', component: () => import('../views/ls-hr/EmployeeGroupEdit.vue') },
